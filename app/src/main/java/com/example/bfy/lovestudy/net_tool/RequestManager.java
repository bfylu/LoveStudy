package com.example.bfy.lovestudy.net_tool;
...
public class RequestManager {
    ...
    private static final String BASE_URL = "http://bfylu.f3322.net:8080/servlet";//请求接口根地址http://bfylu.f3322.net:8080/servlet
